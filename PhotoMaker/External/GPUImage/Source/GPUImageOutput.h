...
@property (readonly) GLuint textureForOutput;
 ...
 */
@property (readonly, strong) UIImage *imageFromCurrentlyProcessedOutput;
@property (readonly) CGImageRef newCGImageFromCurrentlyProcessedOutput CF_RETURNS_RETAINED;
...
- (CGImageRef)newCGImageFromCurrentlyProcessedOutputWithOrientation:(UIImageOrientation)imageOrientation CF_RETURNS_RETAINED;
...
- (CGImageRef)newCGImageByFilteringCGImage:(CGImageRef)imageToFilter orientation:(UIImageOrientation)orientation CF_RETURNS_RETAINED;
