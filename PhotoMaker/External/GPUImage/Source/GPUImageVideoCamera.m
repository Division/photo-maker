        ...
        if ([self cameraPosition] == AVCaptureDevicePositionBack)
        {
            if (_horizontallyMirrorRearFacingCamera)
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationLandscapeRight:default:outputRotation = kGPUImageFlipVertical; break;
                }
            }
            else
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationLandscapeRight:default:outputRotation = kGPUImageRotate180; break;
                }
            }
        }
        else
        {
            if (_horizontallyMirrorFrontFacingCamera)
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationLandscapeRight:default:outputRotation = kGPUImageNoRotation; break;
                }
            }
            else
            {
                switch(_outputImageOrientation)
                {
                    ...
                    case UIInterfaceOrientationLandscapeRight:default:outputRotation = kGPUImageFlipHorizonal; break;
                }
            }
        }
